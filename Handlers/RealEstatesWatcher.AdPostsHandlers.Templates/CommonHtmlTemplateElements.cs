                               ...
                               <div style="padding: 10px; background: #ededed; min-height: 200px;">
                                   ...
                                   <span>
                                       ...
                                       <span style="display: {$address-links-display};">
                                           <a target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/search/?api=1&query={$address-encoded}"><img alt="Google's map logo" title="Otvoriť v Google Mapách" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Google_Maps_icon_%282020%29.svg/40px-Google_Maps_icon_%282020%29.svg.png" style="margin-left: 6px; max-height: 14px; width: auto" /></a>
